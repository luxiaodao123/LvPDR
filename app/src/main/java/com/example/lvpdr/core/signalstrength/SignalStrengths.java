...
//                @Override
//                public double getLevel(CellSignalStrengthLte signalStrength) {
...
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getDbm");
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getGsmLevel");
//                    method.setAccessible(true);
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getGsmDbm");
//                    method.setAccessible(true);
//                    return SignalUtils.getDbmLevel((int) method.invoke(signalStrength));
//                }
//            },
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getCdmaLevel");
//                    method.setAccessible(true);
//                    return (int) method.invoke(signalStrength);
//                }
//            },
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getEvdoLevel");
//                    method.setAccessible(true);
//                    return (int) method.invoke(signalStrength);
//                }
//            },
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getTdScdmaLevel");
//                    method.setAccessible(true);
//                    return (int) method.invoke(signalStrength);
//                }
//
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getTdScdmaDbm");
//                    method.setAccessible(true);
//                    return SignalUtils.getDbmLevel((int) method.invoke(signalStrength));
//                }
//
...
//                @Override
//                public double getLevel(SignalStrength signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getAsuLevel");
//                    method.setAccessible(true);
...
//            },
            new SignalMethod(METHOD_LTE_LEVEL) {
                @Override
                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getLevel");
                    method.setAccessible(true);
                    return (int) method.invoke(signalStrength);
                }
...
//                @Override
//                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
//                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getLteSignalStrength");
//                    method.setAccessible(true);
//                    return (int) method.invoke(signalStrength);
//                }
//
...
//            },
            ...
            new SignalMethod(METHOD_LTE_RSRP) {
                @Override
                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getRsrp");
                    method.setAccessible(true);
            ...
            new SignalMethod(METHOD_LTE_RSRQ) {
                @Override
                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getRsrq");
                    method.setAccessible(true);
            ...
            new SignalMethod(METHOD_LTE_RSSNR) {
                @Override
                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getRssnr");
                    method.setAccessible(true);
            ...
            new SignalMethod(METHOD_LTE_CQI) {
                @Override
                public double getLevel(CellSignalStrengthLte signalStrength) throws Exception {
                    @SuppressLint("SoonBlockedPrivateApi") Method method = signalStrength.getClass().getDeclaredMethod("getCqi");
                    method.setAccessible(true);
                    return (int) method.invoke(signalStrength);
                }
    ...
    public static double get(String methodName, CellSignalStrengthLte signalStrength) {
    ...
    public static double getFirstValid(CellSignalStrengthLte signalStrength) {
        for (SignalMethod method : methods) {
    ...
    public static double getAverage(CellSignalStrengthLte signalStrength) {
